        ...
        if is_start:
            ...
            messages.append({
             ...
             final_report_system_prompt = (
                 ...
                 "### STEP 1: DYNAMIC ANCHORING (Fixing the Index)\n"
                 "Identify the *actual* topic asked in each turn from the Transcript (e.g. 'Automation', 'Conflict', 'Strategy').\n"
                 "- Slot Q1: Intro/Background (Ignore Greetings).\n"
                 "- Slot Q2-Q6: Map precisely to the question asked. Do NOT force hard-coded topics like 'Motivation' if the question was about 'Automation'.\n"
                 "- FALLBACK: If unsure, map answers CHRONOLOGICALLY (Turn 1 -> Q1, Turn 2 -> Q2...).\n\n"
                 ...
                 "MAX SCORE: 5. (No zeroes allowed in final output).\n\n"
